...
rm abcd
```
Das löscht die jeweiligen dateien und Verzeichnisse und in dem Fall abcd.
...
```
Löscht leere Verzeichnisse zb. hier abcd.
...
```
Kopiert die Verzeichnisse und Dateien und wie hier angezeigt abcd.
...
```
Verschiebt oder bennent Dataien und Ordener um.
...
```
Listet Dataien oder Ordner auf wie zb. abcd.

mv und rm haben wir schon in der aufgabe 3 erklärt.